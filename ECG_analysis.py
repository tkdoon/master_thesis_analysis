...
class ECG_analysis():
    ...
    def show_single_rri(self,ts_peaks,rri,ts_1sec,rri_1sec,x,y,show:bool=True,store:bool=True):
         # グラフを描画
    ...
    def show_single_fft(self,frequencies,amp_fft_rri,show:bool=True,store:bool=True):
        fig = plt.figure(figsize=(16,12))
    ...
    def show_single(self,show:bool=True,store:bool=True,modify:bool=True):
        ...
        self.show_single_rri(ts_peaks,rri,ts_1sec,rri_1sec,x,y,show,store)
        self.show_single_fft(frequencies,amp_fft_rri,show,store)
        
    def show_multiple_rri(self,calculate_res_list,n,filename,titles:list=[],large_title:str=None,show:bool=True,store:bool=True):
    ...
    def show_multiple_fft(self,calculate_res_list,n,filename,titles:list=[],large_title:str=None,show:bool=True,store:bool=True)->None:
    ...
    def show_multi_mean_beat(self,calculate_res_list,filename,titles:list[str],large_title:str,show:bool=True,store:bool=True):
        data1=[]
    ...
    def show_multiple(self,titles:list=[],large_title_rri:str=None,large_title_fft:str=None,large_title_mean_beat:str=None,show:bool=True,store:bool=True,modify:bool=True):
        n=len(self.ecg_dfs)
        res_list=[]
        ...
        self.show_multiple_rri(res_list,n,filename,titles,large_title_rri,show,store)
        self.show_multiple_fft(res_list,n,filename,titles,large_title_fft,show,store)
        self.show_multi_mean_beat(res_list,filename,titles,large_title_mean_beat,show,store)
    ...
    # def ecg_analysis(show:bool=True,store:bool=True):    
