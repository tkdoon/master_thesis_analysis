...
def main():
    ...
    key_list=["hf","lf","hf/lf","最大心拍数","最小心拍数","平均心拍数","rriの標準偏差","使用した心電図の番号(0~4,0=電極間,1,2=手首電極ref間,3,4=咬筋電極ref間)","外れ値の数","外れ値の割合","筋運動の平均時間","筋運動の合計時間","回数","アクセルの踏み込み量平均","アクセルの踏み込み量分散","ブレーキの踏み込み量平均","ブレーキの踏み込み量分散","最小車間距離","加速度の二乗平均","加速度の分散","ステアリング角の二乗平均","最大速度","速度の分散","平均速度","ヨー角の最大値","ヨー角の分散","瞼の平均距離","瞳孔の最大直径","瞳孔の最小直径","瞳孔の平均直径","PRC","フラストレーション","全体のワークロード"]
