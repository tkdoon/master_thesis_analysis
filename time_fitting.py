...
class Time_fitting():
    ...
    '''
    def __init__(self,experiment_num:int,subject_num:int,before_time:int=0,after_time:int=-1,delay=0):
        self.experiment_num = experiment_num
        self.delay=delay
        self.path_to_polymate_log = rf"C:\Users\tyasu\Desktop\修士研究用\実験データ\{subject_num}\polymate\実験{experiment_num}.CSV"
        self.path_to_smarteye_log=rf"C:\Users\tyasu\Desktop\修士研究用\実験データ\{subject_num}\smarteye\{experiment_num}.log"
        self.path_to_DS_log=rf"C:\Users\tyasu\Desktop\修士研究用\実験データ\{subject_num}\ds_log\ds{experiment_num}.csv"
        ...
        self.path_to_video=rf"C:\Users\tyasu\Desktop\修士研究用\実験データ\{subject_num}\camera\{experiment_num}.mp4"
        self.cut_video_output_folder=rf"C:\Users\tyasu\Desktop\修士研究用\実験データ\{subject_num}\camera\cut"
